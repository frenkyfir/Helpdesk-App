        ...
        <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true"
            ...
            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Request::is('ticket', 'detailticket*') ? 'active' : '' }}"
                            href="{{ url('ticket') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    {{-- <div class="menu-item">
                        <div class="menu-content">
                            <a class="btn btn-flex btn-color-primary d-flex flex-stack fs-base p-0 ms-2 mb-2 toggle collapsible collapsed"
                                ...
                                <span data-kt-toggle-text-target="true">Show 12 More</span>{!! getIcon('minus-square', 'toggle-on fs-2 me-0') !!}
                                {!! getIcon('plus-square', 'toggle-off fs-2 me-0') !!}</a>
                        </div>
                    </div> --}}
                </div>
                <!--end:Menu sub-->
            ...
            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Request::is('overviewprofile') ? 'active' : '' }}"
                            href="/overviewprofile">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Overview Profile</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Request::is('usermanagement') ? 'active' : '' }}" href="/usermanagement">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
